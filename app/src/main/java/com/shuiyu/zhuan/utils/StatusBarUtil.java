...
public class StatusBarUtil {
    ...
    public static void setWhite(Activity activity){
        ...
        try {
            ...
            e.printStackTrace();
            Log.e("setWhite",activity.getClass().getSimpleName(),e);
        }

        setColor(activity,activity.getResources().getColor(android.R.color.white),statusBarAlpha);
